...
const AccountController = {
    ...
    if(!verifyAccount.status)
	    return customError(verifyAccount.statusCode, res, req, verifyAccount.obj.data, verifyAccount.obj.message);
    ...
    getAllUsersAccounts: (req, res) => {
    	...
    	Account.findAll({
		    ...
		    .then((userAccounts) => {
		    	if(!userAccounts)
		    		return json(200, res, req, 'No account found for this user');
